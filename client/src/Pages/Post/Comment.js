        ...
        <div>
            ...
            <div className="overflow-ellipsis overflow-hidden commentinit">
                ...
                <div className="flex items-center flex-wrap my-4 sm:px-5 px-2 cursor-pointer text-zinc-600 dark:text-zinc-500  dark:border-zinc-700 border-zinc-300 ">
                    <div className="flex items-center mr-2" onClick={() => { setReply(!reply); setEdit(false) }}>
                    ...
                    </div>
                    {
                        comment.is_owner &&
                        <>
                            <div className="flex items-center mr-2" onClick={() => { setEdit(!edit); setReply(false); setIs_anonymous(comment.is_anonymous) }}>
                        ...
                        <form className="flex flex-col bg-zinc-200 dark:bg-zinc-700 w-full md:w-10/12">
                            ...
                            <div className="w-full md:w-full my-2">
                                <textarea
                                    ...
                                    required id="commentContent"></textarea>
                            </div>
                            <div className="w-full flex justify-between">
                                <div className={`${is_anonymous ? 'bg-red-600 text-zinc-300' : 'text-zinc-800 dark:text-zinc-300'} cursor-pointer rounded-full p-1`} onClick={() => setIs_anonymous(!is_anonymous)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-incognito" viewBox="0 0 16 16">
                                ...
                                <div className="cursor-pointer bg-red-600 text-zinc-100 font-medium py-1 px-4 rounded-lg hover:bg-red-500" onClick={() => { if (document.getElementById("commentContent").value != "") updateComment(); setEdit(false) }}>Update</div>
                            </div>
                        </form>
                    </div>
                </div>
