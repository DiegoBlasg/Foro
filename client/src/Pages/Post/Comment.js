...
const Comment = ({ comment, getPostComments }) => {
    const { is_deleteModalOpen, timeAgo, reply, edit, value, is_anonymous, replyComments,
        setIs_DeleteComment, deleteComment, setReply, setEdit, setIs_anonymous, newComment, updateComment, setValue, getReplyComments } = useCommentData(comment, getPostComments)
    return (
        <div>
            {
                is_deleteModalOpen &&
