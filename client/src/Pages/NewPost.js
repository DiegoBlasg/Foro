            ...
            <LayoutDiv>
                <div className="rounded-md p-5 shadow-md w-full bg-zinc-100 dark:bg-zinc-800">
                    ...
                    <div className="flex items-center justify-center mt-5">
                        <div className="flex justify-between w-full sm:w-10/12 dark:text-zinc-300">
                            <h2 className="cursor-pointer px-4 pt-3 pb-2 text-center w-full bg-zinc-300 hover:bg-zinc-300 dark:bg-zinc-700 dark:hover:bg-zinc-700">Write</h2>
                            <h2 className="cursor-pointer px-4 pt-3 pb-2 text-center w-full bg-zinc-200 hover:bg-zinc-300 dark:bg-zinc-600 dark:hover:bg-zinc-700">Preview</h2>
                        </div>
                    </div>
                    <div className="flex items-center justify-center mt-5 ">
                        <div className='bg-zinc-100 flex items-center justify-center w-full sm:w-10/12 py-2 shadow-md rounded-md dark:bg-zinc-800'>
                            <ul className="flex flex-wrap">
                                {
                                    tags.map((tag) => (
                                        <TagToSelect tagsIncluded={tagsIncluded} setTagsIncluded={setTagsIncluded} key={tag.id_tag} tag={tag} />
                                    ))
                                }
                            </ul>
                        </div>
                    ...
                    <div className="flex items-center justify-center mt-5">
                        <form className="flex flex-col bg-zinc-100 dark:bg-zinc-800 w-full sm:w-10/12">
                            <div className="flex flex-col items-center w-full dark:text-zinc-300">
