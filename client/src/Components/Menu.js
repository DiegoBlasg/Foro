...
const Menu = ({ user, setThemDark, themDark }) => {
    ...
    return (
        <div>
            <div className="w-full fixed z-50">
                <div className="flex justify-between items-center bg-zinc-100 text-zinc-800 shadow-sm sm:px-6 dark:bg-zinc-800 dark:text-zinc-200">
                    ...
                    {
                        sowPhoneMenu &&
                        <ul className='sm:flex sm:justify-center bg-zinc-100 fixed sm:static w-full mt-52 sm:mt-0 shadow-md sm:shadow-none dark:bg-zinc-800'>
                            <li className="hover:bg-zinc-200 dark:hover:bg-zinc-700">
                                <Link to="/" onClick={() => { (phone && setSowPhoneMenu(!sowPhoneMenu)); window.scrollTo(0, 0) }} className="h-14 px-6 flex justify-center items-center">
                            ...
                            <li className="hover:bg-zinc-200 dark:hover:bg-zinc-700">
                                <Link to="/profile" onClick={() => { (phone && setSowPhoneMenu(!sowPhoneMenu)); window.scrollTo(0, 0) }} className="h-14 px-6 flex justify-center items-center">
                            ...
                            </li>
                            {
                                themDark ?
                                    <li className="cursor-pointer sm:hidden hover:bg-zinc-200 dark:hover:bg-zinc-700">
                                        <div onClick={() => { (phone && setSowPhoneMenu(!sowPhoneMenu)); setThemDark(false) }} className="h-14 px-6 flex justify-center items-center">
                                    ...
                                    :
                                    <li className="cursor-pointer sm:hidden hover:bg-zinc-200 dark:hover:bg-zinc-700">
                                        <div onClick={() => { (phone && setSowPhoneMenu(!sowPhoneMenu)); setThemDark(true) }} className="h-14 px-6 flex justify-center items-center">
                    ...
                    }
                    {
                        user ?
                            ...
                            <div className="flex items-center justify-center">
                                <div className="flex w-max items-center cursor-pointer rounded-2xl border hover:bg-red-500 bg-red-600 text-white px-3 py-1 font-semibold" onClick={google}>
