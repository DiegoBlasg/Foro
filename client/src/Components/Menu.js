                            ...
                            </li>
                            {
                                theme === "dark" ?
                                    <li className="cursor-pointer sm:hidden hover:bg-zinc-200 dark:hover:bg-zinc-700">
                                        <div onClick={() => { (phone && setSowPhoneMenu(!sowPhoneMenu)); setTheme("light") }} className="h-14 px-6 flex justify-center items-center">
                                    ...
                                    :
                                    <li className="cursor-pointer sm:hidden hover:bg-zinc-200 dark:hover:bg-zinc-700">
                                        <div onClick={() => { (phone && setSowPhoneMenu(!sowPhoneMenu)); setTheme("dark") }} className="h-14 px-6 flex justify-center items-center">
